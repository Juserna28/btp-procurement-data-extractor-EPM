...
entity SurveyResponse_AN : managed {
    ...
    key QuestionSourceSystem                 : String(100);
        ...
        cus_tipocontrato_nn49l               : Composition of many SurveyResponse_tipocontrato_AN
                                                   on cus_tipocontrato_nn49l.SurveyResponse = $self;
...
entity SurveyResponse_tipocontrato_AN : cuid {
